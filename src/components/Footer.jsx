...
import Facebook from '../assets/img/facebook-blanco.svg';
import GitHub from '../assets/img/github-blanco.svg';
import Linkedin from '../assets/img/linkedin-blanco.svg';

const Footer = () => {
    return (
        <footer className="shadow-lg py-3" id="footer">
            <div className="container-fluid">
                <div className="row d-flex text-center justify-content-center align-items-center">
                    <div className="col-12 text-white">
                    <a href="https://eduardovr.com" target="_blank" rel="noopener noreferrer">

                        <p className="text-light"> &copy;&nbsp;Eduardo Venegas 2021</p>
                    </a>
                    </div>
